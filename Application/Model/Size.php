...
class Size extends HS_DatabaseObject {
	protected $id; // Int
	...
	public static function fromDB($id, $subdomain = null) {
		global $OBJECT_MAP;
		if ( ! isset($OBJECT_MAP["Size"])) {
			$OBJECT_MAP["Size"] = array();
		}
		$obj = null;
		if (isset($OBJECT_MAP["Size"][$id])) {
			$obj = $OBJECT_MAP["Size"][$id];
		} else {
			$obj = parent::fromDBHelper(new self($subdomain), array("id" => $id));
			$OBJECT_MAP["Size"][$id] = $obj;
		}
		return $obj;
	}
	...
	public static function create($clientDataObj, $subdomain=null) {
		...
		if (isset($clientDataObj->id) && self::exists(array("id" => $clientDataObj->id))) {
			return "A Size already exists with that id - you cannot have duplicate entries.";
		}
	...
	public static function createWhereArray($whereData, $prefix="") {
		...
		if (isset($whereData["id"])) {
			$whereArray["{$prefix}Size.id"] = $whereData["id"];
		}
		else {
			if (isset($whereData["name"])) {
				$whereArray["{$prefix}Size.name"] = $whereData["name"];
			}
		}
	...
	// TODO: fill in this array with column(s) to order results by like this: array("Size.name" => "ASC")
		return array();
	}
	...
	protected function deleteLinks() {
		// N-1 Links
		if (Card::countEntries(array("Card.sizeID" => $this->id)) > 0) {
			return "Unable to delete Size because one or more Card is dependent on it.";
		}
