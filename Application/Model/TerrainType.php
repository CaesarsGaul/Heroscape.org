...
class TerrainType extends HS_DatabaseObject {
	...
	// TODO: fill in this array with column(s) to order results by like this: array("TerrainType.name" => "ASC")
		return array();
	}
	...
	public static function getColumnNames() {
		return array("id", "name", "height", "color", "rules");
	}
	...
	public function updateInDB($clientDataObj = null) {
		...
		if ($clientDataObj != null) {
			...
			if (property_exists($clientDataObj, "rules")) {
		...
		$this->dbUpdate((new MySQLBuilder())->
			update("TerrainType",
				array("name", "height", "color", "rules"),
				array($this->name, $this->height, $this->color, $this->rules))->
