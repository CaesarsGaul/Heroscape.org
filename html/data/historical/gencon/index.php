...
<body><div id='content'>
	...
	<div id='pageContent'>	
		...
		<article>
			...
			<h4>Finals</h4>
			<p>1st - dok (Tor-Kul-Na, Marrden Nagrubs x3, Krav Maga Agents, Raelin the Kyrie Warrior (RotV), Otonashi)</p>
			<p>2nd - Spider Poison (Gladiatrons x3, Blastatrons x2, Raelin the Kyrie Warrior (RotV), Black Wyrmling x2)</p>
			<p>Map - Trailblazer (Wannok, Valda)</p>
			
			<h2>2012</h2>
			<h3>Main Event (RtW Day 2)</h3>
			<h4>Finals</h4>
			<p>1st - MatterTruckRally (Gladiatrons x3, Blastatrons x2, Raelin the Kyrie Warrior (RotV))</p>
			<p>2nd - cornpuff (Axegrinders of Burning Forge x2, Mogrimm Forgehammer, Airborne Elite, Raelin the Kyrie Warrior (RotV))</p>
			<p>Map - Elswin Plateau (Valda, Kelda)</p>
